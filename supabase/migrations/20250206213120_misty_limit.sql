...
BEGIN
  ...
  VALUES (
    ...
    CASE 
      ...
      THEN TO_DATE(NEW.raw_user_meta_data->>'dateOfBirth', 'DD.MM.YYYY')
      ELSE NULL
    END,
    NEW.raw_user_meta_data->>'guardianFirstName',
    NEW.raw_user_meta_data->>'guardianLastName',
    NEW.raw_user_meta_data->>'guardianEmail',
    NEW.raw_user_meta_data->>'guardianPhone'
  );
